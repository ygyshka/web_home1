...
<main>
    ...
    <div class="container">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-lg btn-outline-primary
                             btn btn-success text-white">Купить
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <main class="row mt-5 text-center">
            <h3>FAQ</h3>
            <div class="row mt-3">
                <div class="col-4">
                ...
                <div class="collapse" id="collapseExample1">
                    <div class="card card-body">
                        Чтобы купить, необходимо выбрать товар и заполнить форму для заказа
                    </div>
                </div>
                <div class="collapse" id="collapseExample2">
                    <div class="card card-body">
                        Чтобы доставить товар, необходимо указать место доставки
                    </div>
                </div>
